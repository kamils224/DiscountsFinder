...
from discounts_finder.repositories.products_tasks_repository import ProductsTaskRepository, ProductsTaskRead
...
def process_products_url(object_id: str, url: str) -> None:
    ...
    products_tasks_repository.update(object_id, {"results": products, "count": len(products),
